...
ssh -q -o StrictHostKeyChecking=no -L8999:172.30.136.3:22 -g -N <user>@<hostname>.com -f

echo "Logging into Decatur NNM"

ssh -q -o StrictHostKeyChecking=no -L8998:10.32.102.68:22 -N <user>@localhost -p 8999 -f
